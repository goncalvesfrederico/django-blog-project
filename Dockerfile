...
LABEL mantainer="https://github.com/goncalvesfrederico"
...
# Isso faz com que eu não preciso ativar o meu ambiente virtual.
# porque a primeira pasta que ele vai procurar é a pasta scripts e depois a pasta /venv/bin, e ele vai encontrar na segunda pasta.
ENV PATH="/scripts:/venv/bin:$PATH"

# Muda o usuário para duser
USER duser

# Executa o arquivo scripts/commands.sh (comando inicial)
CMD ["commands.sh"]